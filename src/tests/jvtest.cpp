...
int main(int argc, char *argv[]) {
    ...
    minicore::jv::JVSolver<blaze::DynamicMatrix<float>, float, uint32_t> jvs(dists, 5903.483329773);
    ...
    minicore::jv::JVSolver<blaze::DynamicMatrix<float>, float, uint32_t> jvs2(jvs, 14000);
